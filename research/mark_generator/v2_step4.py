...
def add_random_mark(image):
    ...
    def add_handwritten_mark(image, mark_type='doodle', alpha=random.uniform(0.03, 0.6), beta=random.uniform(0.03, 0.6), gamma=random.uniform(0.03, 0.6)):
...
for i, image in tqdm(enumerate(images)):
    ...
    for j in tqdm(range(2500)):
        ...
        marked_image.save(f'data/output/unmarked/{i}/unmarked_{j}.jpg')
